...
import ReviewImg from "@/public/images/about/profile.jpg";
...
const CategoryCard = ({
  ...
  <div className="bg-white rounded-lg shadow-lg overflow-hidden">
    <Link href={link}>
      ...
      />
      <div className="p-6">
        <h3 className="text-xl font-semibold mb-2">{name} Watches</h3>
        <p className="text-gray-600">
          Discover our exquisite range of {name.toLowerCase()} timepieces,
